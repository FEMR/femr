...
import femr.ui.views.html.confirm.index; // this is what was needed to render the new page
...
public class ConfirmController extends Controller {
    ...
    @Inject
    public ConfirmController(AssetsFinder assetsFinder, ISessionService sessionService) {
