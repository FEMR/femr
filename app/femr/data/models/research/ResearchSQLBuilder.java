...
public class ResearchSQLBuilder {
    ...
    /**
     * Constructor or ResearchSQLBuilder
     * @param input the string generated by the user to query with
     * @param patientResearch the object containing the lookup tables
     */
