...
@Entity
@Table(name = "mission_cities")
public class MissionCity implements IMissionCity {
    @Id
    ...
    @JoinColumn(name = "mission_country_id", nullable = false)
    ...
    public void setMissionCountry(IMissionCountry missionCountry) {
        this.missionCountry = (MissionCountry) missionCountry;
    }
}
