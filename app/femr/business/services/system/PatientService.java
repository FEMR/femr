...
public class PatientService implements IPatientService {
    ...
    public ServiceResponse<PatientItem> updateSex(int id, String sex) {
        ...
        try {
            ...
            PatientItem patientItem = itemModelMapper.createPatientItem(savedPatient.getId(),
                    ...
                    savedPatient.getAge(),
                    savedPatient.getIsDobEstimated(),
                    savedPatient.getSex(),
                    null,
                    null,
                    null,
    ...
    public ServiceResponse<PatientItem> createPatient(PatientItem patient) {
        ...
        try {
            IPatient newPatient = dataModelMapper.createPatient(patient.getUserId(), patient.getFirstName(), patient.getLastName(), patient.getBirth(), patient.getIsDobEstimated(), patient.getSex(), patient.getAddress(), patient.getCity(), patient.getPhotoId());
