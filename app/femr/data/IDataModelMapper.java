...
public interface IDataModelMapper {
     ...
     */
    IPatient createPatient(int userID, String firstName, String phoneNumber, String lastName, Date birthday, String sex, String address, String city, Integer photoID);
