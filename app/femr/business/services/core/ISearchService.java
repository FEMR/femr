...
public interface ISearchService {
     ...
     *
     * @param userId id of the user searching for patients, not null
     * @param tripId id of the current trip, may be null
     * @return a service response that contains a list of PatientItems
     * and/or errors if they exist. If tripId is null, patients will not
     * be filtered by country.
     */
    ServiceResponse<List<PatientItem>> retrievePatientsForSearch(int userId, Integer tripId);
