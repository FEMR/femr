    ...
    var methods = {
        ...
        displayGrid: function(refresh_pag) {
            ...
            var res = $.ajax({
                ...
                /* Alaa Serhan - Serialize the data to pass it to back end for it to be parsed there */
                data: JSON.stringify({
                    page_num: s.pageNum,
                ...
                /* Alaa Serhan - Need to add following line for Play to parse JSON properly
                 Because fEMR is using the Play Framework. In order to parse the data we need to pass the contentType header   */
